...
def draw_box_4pt(img, pt, color=(0, 255, 0), thickness=2):
    ...
    img = cv2.line(img, (pt[0], pt[1]), (pt[2], pt[3]), 255, thickness)
    img = cv2.line(img, (pt[0], pt[1]), (pt[6], pt[7]), 255, thickness)
    img = cv2.line(img, (pt[4], pt[5]), (pt[6], pt[7]), 255, thickness)
    img = cv2.line(img, (pt[4], pt[5]), (pt[2], pt[3]), 255, thickness)
    return img
...
def draw_box_2pt(img, pt, color=(0, 255, 0), thickness=1):
    ...
    img = cv2.rectangle(img, (pt[0], pt[1]), (pt[4], pt[5]), color, thickness=thickness)
    return img
